...
export const notificationsApi = {
  ...
  trackClick: (id) => api.post(`/notifications/${id}/click`),
...
export const adminApi = {
  ...
  updateUserStatus: (id, status) => api.put(`/admin/users/${id}/status`, { status: status.toUpperCase() }),
  ...
  toggleMission: (id, isActive)   => api.patch(`/missions/${id}/toggle`, { isActive }),
