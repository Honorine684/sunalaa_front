...
export default function LoginPage() {
  ...
  async function handleOtpSubmit(e) {
    e.preventDefault();
    if (otpCode.length !== 6) { setApiError("Please enter a 6-digit code"); return; }
    setLoading(true);
    setApiError("");
    try {
          ...
          {twoFaStep ? (
            <>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-white" style={{ fontSize: 22, fontWeight: 700 }}>2FA Verification</h1>
                  <p className="text-white/60 text-[13px]">Enter the code generated by your authentication app</p>
                </div>
              </div>
            ...
            <>
              <h1 className="text-white mb-5" style={{ fontSize: 28, fontWeight: 700 }}>Login</h1>
