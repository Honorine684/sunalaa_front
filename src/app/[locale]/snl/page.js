...
export const metadata = {
  title: "Comprendre le token $SNL",
  description:
    "Tout savoir sur le token SNL de SUNALAA : son utilité, sa valeur, ses usages dans l'écosystème et comment en accumuler gratuitement chaque jour.",
  alternates: { canonical: "https://sunalaa.com/snl" },
  openGraph: {
    url: "https://sunalaa.com/snl",
    title: "Le token $SNL | SUNALAA",
    description:
      "Qu'est-ce que le SNL ? Découvrez le token natif de SUNALAA, son utilité et comment l'accumuler gratuitement.",
  },
};
