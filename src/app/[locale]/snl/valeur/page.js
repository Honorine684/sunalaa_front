...
export const metadata = {
  title: "Pourquoi le $SNL a de la valeur",
  description:
    "La valeur du token SNL repose sur la rareté, la demande croissante et l'utilité au sein de l'écosystème SUNALAA. Comprenez les fondamentaux économiques du SNL.",
  alternates: { canonical: "https://sunalaa.com/snl/valeur" },
  openGraph: {
    url: "https://sunalaa.com/snl/valeur",
    title: "Valeur du $SNL | SUNALAA",
    description:
      "Rareté, demande et utilité : pourquoi le token SNL de SUNALAA a de la valeur et comment elle évolue.",
  },
};
