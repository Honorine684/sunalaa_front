    ...
    <div className="min-h-screen bg-primary flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-[860px] flex flex-col items-center gap-6">
        ...
        <form className="flex flex-col gap-[18px]">
          ...
          {/* Warning box */}
          <div className="bg-[#FFF8E6] border border-[#E6B84C]/40 rounded-lg px-4 py-3">
            <p className="text-red-500 text-[13px] font-semibold mb-1">
              ✓ Obligatoire :
            </p>
            <p className="text-gray-700 text-[12px] leading-relaxed">
              Chaque inscription nécessite un code de parainage.
              <br />→ Code par défaut actif (SUNALAA-ADMIN). Vous pouvez le
              remplacer si vous avez un autre code.
            </p>
          </div>
