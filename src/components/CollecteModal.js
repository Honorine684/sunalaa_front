...
export default function CollecteModal({ onClose, onCollected }) {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col items-center relative w-[90vw] mx-4 gap-3.5 sm:gap-5 p-4 sm:p-5"
        style={{ maxWidth: 474, borderRadius: 28, backgroundColor: "#1F4E46" }}
      ...
      >
        ...
        <div className="text-center flex flex-col gap-2">
          <h2 className="text-white font-bold text-[18px] sm:text-[22px] leading-snug">
            {state === "success"
              ? t("title_success")
              : state === "already"
              ? t("title_already")
