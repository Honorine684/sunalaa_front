  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M6.3 6.3a8 8 0 000 11.4M17.7 17.7a8 8 0 000-11.4M3.5 3.5a13 13 0 000 17M20.5 20.5a13 13 0 000-17" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="px-3 pb-5 pt-2 flex flex-col gap-1">
        ...
        <button onClick={handleLogout} className="flex items-center gap-3 w-full px-4 py-2.5 rounded-xl text-[14px] text-white/60 hover:text-white hover:bg-white/10 transition-all duration-200 cursor-pointer">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
